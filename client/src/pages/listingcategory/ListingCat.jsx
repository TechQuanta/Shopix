...
import Sidebar from '../listing/sidebar/Sidebar';
...
const ListingCat = () => {
    ...
    const [subcatName, setSubcatName] = useState(catname);
    ...
    const getProductData = async () => {
        ...
        const fetchData = await fetch(SummaryApi.catProductPage.url + `?category=${catname}`, {
